...
class ControllerCaptcha extends Controller {
    /**
     * Conscteur de la clse
     *
     * @param \Twig\Environment $twig L'environmnt Twg
     * @param \Twig\Loader\FilesystemLoader $loader Le lodr Twg pr chrg des tmplts
     */
    ...
    public function FctDegueulasse() {
        ...
        $resultats2 = $this->bouclesImbriqueesInutiles(14);
